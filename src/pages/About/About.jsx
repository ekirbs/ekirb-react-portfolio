  ...
  return (
    <div className="aboutCard">
      ...
      <div className="aboutMain">
        <p className="aboutCardContent col-9">Hello! My name is Eric Kirberger and I am an aspiring Full Stack Web Developer. I am currently in the Rutgers Coding Bootcamp, with a constantly improving knowledge of important programming technologies, including: </p>
